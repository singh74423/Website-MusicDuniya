...
<div class="double-line"></div>
        <div style="text-align: center;font-family:'Courier New', Courier, monospace;">HollyWood</div>
        <div class="double-line"></div>
 ...
 <table id="post-table" >
    <?php  $z=0;
    $q = "SELECT * FROM datafiles where type='H';";
...
<script>
    ...
    document.getElementById("active_3").className="active";
    </script>
</html>